...
describe('doGenerate', () => {
  ...
  it('should extract logprobs', async () => {
    ...
    expect(response.providerMetadata?.ollama.logprobs).toStrictEqual(
    ...
    expect(await convertReadableStreamToArray(stream)).toMatchInlineSnapshot(`
      [
        ...
        },
        {
          "error": {
            "code": null,
            "message": "The server had an error processing your request. Sorry about that! You can retry your request, or contact us through our help center at help.ollama.com if you keep seeing this error.",
            "param": null,
            "type": "server_error",
          },
          "type": "error",
